...
public class MyKafkaConsumer {
    public static void main(String[] args) {
        ...
        consumer.subscribe(Collections.singletonList(KafkaConstant.TOPIC)); //Arrays.asList()

        while (true) {
            //获取数据
            ConsumerRecords<String, String> consumerRecords = consumer.poll(Duration.parse("PT1M"));
