...
public class CommonUtils {
    ...
    public static String checkMobileLegal(String mobile) {
        if (StringUtils.isBlank(mobile)) {
            return "手机号不能为空！";
        }
        if (StringUtils.isNotBlank(mobile) && !mobile.matches("^1[3|4|5|7|8|9][0-9]{9}$")) {
            return "手机号格式不正确！";
        }
        return "";
    }
    ...
    public static boolean checkMobile(String mobile) {
        return StringUtils.isBlank(checkMobileLegal(mobile));
    }

    @Test
    public void testMobile() {
        String mobile = "19288888880";
        String validateMobile = checkMobileLegal(mobile);
        System.out.println("validateMobile = " + validateMobile);
